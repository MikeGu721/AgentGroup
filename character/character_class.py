...
from character.action_modules.interview import run_interview
from character.action_modules.act import run_act
from character.action_modules.converse import run_converse
from character.action_modules.perceive import run_perceive
from character.action_modules.update import run_update
from character.action_modules.vote import run_vote
from character.action_modules.speech import run_speech
...
class Character:
    ...
    def update_relation_judgement(self, all_action_description: str,
        ...
        reflect_thought, relationship_change, belief_change, judgement_change = run_update(self.id_number,
                                                                                           self.get_self_description(),
                                                                                           self.get_all_belief(),
    ...
    def speech(self, action_history_desc, rule_setting, candidates, resources):
        '''
        让角色最终发言
        Input:
            action_history: str,
    ...
    def speech_round(self, action_history_desc, candidates, resources, rule_setting, round_description):
        '''
        让角色最终发言
        Input:
            action_history: str,
    ...
    def act(self,
            ...
            chat_round_num: int,
            requirement_list: list=None) -> str:
        '''
        ...
        '''
        action_history, thought, plan, candidate = run_act(self.id_number,
                                                           self.get_self_description(),
                                                           environment_summary,
                                                           round_description,
    ...
    def converse(self,
        ...
        number_of_action_history, thought, new_action_history = run_converse(self.id_number,
    ...
    def interview(self, question: str, environment: str, all_characters: str) -> str:
        '''
        访谈，等评估阶段再说
        Input:
            question: str,
            environment_summary: str,
            all_characters_description: str,
        Output:
            response: str
        '''
        response = run_interview(self, question, environment, all_characters)
        return response
